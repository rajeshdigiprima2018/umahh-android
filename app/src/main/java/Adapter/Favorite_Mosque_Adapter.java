...
public class Favorite_Mosque_Adapter  extends RecyclerView.Adapter<Favorite_Mosque_Adapter.MyViewHolder> {
    ...
    public Favorite_Mosque_Adapter(Context mContext, ArrayList<Bookmark_Modal> flatList) {
        this.mContext = mContext;
        this.flatList = flatList;
    }

    @Override
    public Favorite_Mosque_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.favorite_mosque_adapter, parent, false);

        return new Favorite_Mosque_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Favorite_Mosque_Adapter.MyViewHolder holder, int position) {
