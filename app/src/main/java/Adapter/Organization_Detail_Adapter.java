...
public class Organization_Detail_Adapter  extends RecyclerView.Adapter<Organization_Detail_Adapter.MyViewHolder> {
    private Context mContext;
    private ArrayList<Organization_Detail_Modal> flatList;
    ...
    public Organization_Detail_Adapter(Context mContext, ArrayList<Organization_Detail_Modal> flatList) {
        this.mContext = mContext;
        this.flatList = flatList;
    }

    @Override
    public Organization_Detail_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.organization_detail_adapter, parent, false);

        return new Organization_Detail_Adapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final Organization_Detail_Adapter.MyViewHolder holder, int position) {
        Organization_Detail_Modal album = flatList.get(position);
