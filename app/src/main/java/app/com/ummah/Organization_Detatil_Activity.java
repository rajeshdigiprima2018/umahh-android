...
import Adapter.Organization_Detail_Adapter;
import Modal.Organization_Detail_Modal;
...
public class Organization_Detatil_Activity  extends AppCompatActivity implements View.OnClickListener {
    ...
    private Organization_Detail_Adapter organization_detail_adapter;
    public ArrayList<Organization_Detail_Modal> modalList;
    Bundle bundle;
    ...
    private void Recycle_view() {
        ...
        recyclerView.addItemDecoration(new Organization_Detatil_Activity.GridSpacingItemDecoration(1, dpToPx(10), true));
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(Organization_Detatil_Activity.this, Business_inner_Detail_Activity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.Base_url+"business/getByCategoryBusinessList",
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Log.e("Organization list", response);
                        try {
                            JSONObject json = new JSONObject(response);
                            Log.e("Organization List", json.toString());
                            if (json != null) {
                                ...
                                if (json.has("success")) {
                                    ...
                                    if (success.equals("true")) {
                                        ...
                                        for (int i = 0; i < lengthJsonArr; i++) {
                                            Organization_Detail_Modal List_modal = new Organization_Detail_Modal();
                                        ...
                                        if (modalList.size() > 0) {
                                            organization_detail_adapter = new Organization_Detail_Adapter(Organization_Detatil_Activity.this, modalList);
                                            recyclerView.setAdapter(organization_detail_adapter);
                                            organization_detail_adapter.notifyDataSetChanged();
                                        }
                                        hideProgressDialog();

                                    } else {
                                        Toast.makeText(Organization_Detatil_Activity.this, "No Data Found.", Toast.LENGTH_LONG).show();
                                        hideProgressDialog();
                                    }
                                }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("businessType", "Organization");
                return map;
            }
        };
        RequestQueue requestQueue = Volley.newRequestQueue(Organization_Detatil_Activity.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Organization_Detatil_Activity.this, Organization_Activity.class);
        startActivity(intent);
        finish();
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
    }
