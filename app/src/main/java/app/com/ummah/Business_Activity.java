...
import Adapter.Business_Adapter;
...
public class Business_Activity  extends AppCompatActivity implements View.OnClickListener {
    ...
    Business_Adapter board_adapter;
    public ArrayList<Business_Modal> modalList;
    ...
    private void Recycle_view() {
        ...
        recyclerView.addItemDecoration(new Business_Activity.GridSpacingItemDecoration(1, dpToPx(10), true));
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(Business_Activity.this, Business_Detatil_Activity.class);
                                ...
                                if (json.has("success")) {
                                    ...
                                    if (success.equals("true")) {
                                        ...
                                        for (int i = 0; i < lengthJsonArr; i++) {
                                            Business_Modal List_modal = new Business_Modal();
                                        ...
                                        if (modalList.size() > 0) {
                                            board_adapter = new Business_Adapter(Business_Activity.this, modalList);
                                        ...
                                        Toast.makeText(Business_Activity.this, "No Data Found.", Toast.LENGTH_LONG).show();
                                        hideProgressDialog();
                                    }
                                }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Business_Activity.this, MainActivity.class);
        startActivity(intent);
        finish();
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
    }
