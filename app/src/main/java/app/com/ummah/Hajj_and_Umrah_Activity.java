...
import Adapter.Hajj_and_Umrah_Adapter;
...
public class Hajj_and_Umrah_Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    Hajj_and_Umrah_Adapter board_adapter;
    public ArrayList<Hajj_and_Umrah_Modal> modalList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hajj_and_umrah);
        All_Depndency();
    ...
    private void API() {
        ...
        showProgressDialog();
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constant.Base_url+"hajjumrah/getAllCategoryUmrah",
                                ...
                                if (json.has("success")) {
                                    ...
                                    if (success.equals("true")) {
                                        ...
                                        for (int i = 0; i < lengthJsonArr; i++) {
                                            Hajj_and_Umrah_Modal List_modal = new Hajj_and_Umrah_Modal();
                                            JSONObject jsonChildNode2 = jsonMainNode.getJSONObject(i);
                                            String name = jsonChildNode2.optString("name").toString();
                                            String imageUrl = jsonChildNode2.optString("imageUrl").toString();
                                            ...
                                            List_modal.setImageUrl(imageUrl);
                                        ...
                                        if (modalList.size() > 0) {
                                            board_adapter = new Hajj_and_Umrah_Adapter(Hajj_and_Umrah_Activity.this, modalList);
                                        ...
                                        Toast.makeText(Hajj_and_Umrah_Activity.this, "No Data Found.", Toast.LENGTH_LONG).show();
                                        hideProgressDialog();
                                    }
                                }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Hajj_and_Umrah_Activity.this);
    ...
    private void Recycle_view() {
        ...
        recyclerView.addItemDecoration(new Hajj_and_Umrah_Activity.GridSpacingItemDecoration(1, dpToPx(10), true));
    ...
    private void Click_Event() {
        ...
        /*lay_umarah.setOnClickListener(this);
    ...
    private void Find_Element() {
     ...
     /*   lay_hajj = (LinearLayout) findViewById(R.id.lay_hajj);
        lay_umarah = (LinearLayout) findViewById(R.id.lay_umarah);*/
    ...
    /*        case R.id.lay_hajj:
          ...
          /*  case R.id.lay_umarah:

                Intent intent2 = new Intent(Hajj_and_Umrah_Activity.this, Umrah_activity.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Hajj_and_Umrah_Activity.this, MainActivity.class);
        startActivity(intent);
        finish();
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
    }
