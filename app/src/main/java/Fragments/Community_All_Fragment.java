...
import Adapter.Community_All_Adapter;
...
public class Community_All_Fragment extends Fragment implements View.OnClickListener {

    Community_All_Adapter adaptor;
    RecyclerView recyclerView;
    ArrayList<Community_Modal> modalList = new ArrayList<>();
    ...
    private void Upcomeing_list() {

        showProgressDialog();
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Constant.Base_url + "user/Community/getAllList/",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.e("Community All list", response);
                        try {
                            JSONObject json = new JSONObject(response);
                            Log.e("Community all List", json.toString());
                            if (json != null) {
                                ...
                                if (json.has("success")) {
                                    ...
                                    if (success.equals("true")) {
                                        ...
                                        if (modalList.size() > 0) {
                                            adaptor = new Community_All_Adapter(getActivity(), modalList, (session.getuserinfo().get(Constant.SHARED_PREFERENCE_USER_ID_KEY)));
    ...
    private void findElement(View rootView) {
        ...
        recyclerView.addItemDecoration(new Community_All_Fragment.GridSpacingItemDecoration(1, dpToPx(10), true));
